...
public class LocalDateTimeExample {
    public static void main(String[] args) {
        ...
        LocalDateTime dateTime = LocalDateTime.of(1994, Month.DECEMBER, 4, 10, 43, 34);
        ...
        System.out.println("The given date value is: " + dateLocal);

        LocalTime timeLocal = dateTimeVal.toLocalTime();
        System.out.println("The given time value is: "+timeLocal);
